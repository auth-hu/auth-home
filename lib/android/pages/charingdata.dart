...
class Chargingdata extends StatefulWidget {
  const Chargingdata({super.key});

  @override
  State<Chargingdata> createState() => _ChargingdataState();
}

class _ChargingdataState extends State<Chargingdata> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            Apppar(title: "جكات شحن", search: false),
            ...
            Expanded(
              child: Container(
                ...
                child: StreamBuilderData(collection: "charging"),
              ),
            ),
          ],
        ),
